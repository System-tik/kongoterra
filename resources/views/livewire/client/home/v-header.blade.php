<div class="flex flex-col items-center justify-center" x-data="{
    ...
    <div class="w-screen bg-cover" style="background-image:url('{{ asset('img/fond/ac.jpg') }}'); height:60vh;" >
        <div class="flex flex-col justify-center w-full h-full px-5 text-white 2xl:px-64 lg:px-5 md:px-24 xl:px-24" style="background-color: rgba(0, 0, 0, .3)" data-aos="fade-down-right">
            ...
            <p class="block px-5 py-2 text-lg text-justify lg:py-5 animate__animated animate__fadeInRight lg:hidden" x-show="about[0]" style="background-color: ">
                {{ substr($abouts[0]->descrip, 0, 200) }}... <a href="{{route('about', $abouts[0]->id)}}" class="text-green-400">Lire plus.</a>
            </p>
    ...
    @endif
    <div class="flex items-center w-full text-gray-200 lg:text-2xl justify-evenly" style="height:30vh; /* gap:10rem */">
        <button class="flex flex-col items-center justify-center gap-5 text-gray-500 " @click="aff(0)" data-aos="flip-left">
            <div class="p-5 text-white bg-green-600 rounded-full">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            </div>
            <p>Kongoterra</p>
        </button>
        <button class="flex flex-col items-center justify-center gap-5 text-gray-500" @click="aff(1)" data-aos="flip-left">
            <div class="p-5 text-white bg-green-600 rounded-full">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            </div>
            <p>Vision</p>
        </button>
        <button class="flex flex-col items-center justify-center gap-5 text-gray-500" @click="aff(2)" data-aos="flip-left">
            <div class="p-5 text-white bg-green-600 rounded-full">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            </div>
            <p>Notre But</p>
