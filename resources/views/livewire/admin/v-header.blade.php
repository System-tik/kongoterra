<div x-data="{
    ...
    <div class="grid h-full grid-cols-3 gap-3">
        <div class="h-full p-4 rounded bg-gray-50">
            <h1 class="py-2 text-xl font-bold">Mise à jour de données |  Entete de la page</h1>
            <hr>
            <div class="pt-2">
                <div class="">
                    <label class="">Titre</label>
                    <textarea  rows="10" class="w-full p-2 mt-2" placeholder="Titre de l'info" wire:model="text"></textarea>
                </div>
            </div>
        ...
        <div class="col-span-2 p-4 rounded bg-gray-50">
            ...
            <div class="grid w-full grid-cols-2 gap-4 py-3">
                @forelse ($headers as $hd)
                    <div class="flex rounded shadow cursor-pointer" wire:click="fillInputs({{$hd}})">
    ...
    <div class="absolute top-0 left-0 w-full bg-black" id="notif2">
    ...
    <script>
        var a = document.querySelector('#notif2');
